...
// local per UX_SPEC 2). No day arithmetic lives here. Both result copy and the
// UI format dates through this module so one instant never reads as two
// different local calendar days; `src/ui/format.ts` re-exports it.
