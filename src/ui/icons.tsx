...
export function GearIcon(props: SvgProps) {
  return (
    <Glyph {...props}>
      ...
      <path
        d="M10.611 2.703 A9.4 9.4 0 0 1 13.389 2.703 L13.005 5.275 A6.8 6.8 0 0 1 16.045 6.534 L17.591 4.444 A9.4 9.4 0 0 1 19.556 6.409 L17.466 7.955 A6.8 6.8 0 0 1 18.725 10.995 L21.297 10.611 A9.4 9.4 0 0 1 21.297 13.389 L18.725 13.005 A6.8 6.8 0 0 1 17.466 16.045 L19.556 17.591 A9.4 9.4 0 0 1 17.591 19.556 L16.045 17.466 A6.8 6.8 0 0 1 13.005 18.725 L13.389 21.297 A9.4 9.4 0 0 1 10.611 21.297 L10.995 18.725 A6.8 6.8 0 0 1 7.955 17.466 L6.409 19.556 A9.4 9.4 0 0 1 4.444 17.591 L6.534 16.045 A6.8 6.8 0 0 1 5.275 13.005 L2.703 13.389 A9.4 9.4 0 0 1 2.703 10.611 L5.275 10.995 A6.8 6.8 0 0 1 6.534 7.955 L4.444 6.409 A9.4 9.4 0 0 1 6.409 4.444 L7.955 6.534 A6.8 6.8 0 0 1 10.995 5.275 Z"
        {...stroke}
      />
    </Glyph>
  );
