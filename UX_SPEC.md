...
- Safety/eligibility block: slot `safety_first_launch` — ships in place as the following lines, in this order, rendered as one paragraph each:
  - For adults.
