...
One-tap check-ins with persistent Undo, **Manage break → Update last use**, the cut-down tracker and its session log, History's dated groups, the backup/restore contract and the viewport sizing rule are unchanged from 0.37.0; browser zoom is no longer one of them (it is locked, see below).
