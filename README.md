...
**Version 0.35.0** · [Open the app](https://megabomb420.github.io/tbreak-calculator/) · [Cloudflare Pages mirror](https://tbreak-calculator.pages.dev/)
...
Verify the deployment you care about, then open the live app and check Settings → About for **0.35.0**. Existing PWA users receive an update prompt once the replacement service worker is ready. Historical release details are retained in Git history.
