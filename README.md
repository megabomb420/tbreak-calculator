...
**Version 0.21.1** · [Open the app](https://megabomb420.github.io/tbreak-calculator/)
...
Verify the Pages workflow succeeded, then open the live app and check Settings → About for **0.21.1**. Existing PWA users receive an update prompt once the replacement service worker is ready. Historical release details are retained in Git history.
